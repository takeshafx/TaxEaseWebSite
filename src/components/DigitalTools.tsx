...
const features = [{
  ...
  description: 'Manage your taxes from anywhere with our top-rated iOS and Android apps.',
  icon: Smartphone
}, {
  name: 'Bank-Level Security',
  description: '256-bit encryption and secure cloud storage keep your data safe.',
  icon: Lock
}, {
  name: 'Real-time Updates',
  description: 'Get notified the moment your return is accepted or your refund is sent.',
  icon: RefreshCw
}, {
  name: '24/7 Support',
  description: 'Our AI chat is always on, with human experts available during business hours.',
  icon: Clock
}];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-gray-400 mb-8 leading-relaxed">
              We've reimagined the tax experience to be as seamless as your
              favorite apps. No clunky portals, no fax machines, just smooth,
